...
private slots:
    ...
    QString BuyPTM(QString OrderType, double Quantity, double Rate);
    QString SellPTM(QString OrderType, double Quantity, double Rate);
