...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizePositroniumAmount"))
        settings.setValue("nAnonymizePositroniumAmount", 1000);
    nAnonymizePositroniumAmount = settings.value("nAnonymizePositroniumAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizePositroniumAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizePositroniumAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizePositroniumAmount:
            return QVariant(nAnonymizePositroniumAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizePositroniumAmount:
            nAnonymizePositroniumAmount = value.toInt();
            settings.setValue("nAnonymizePositroniumAmount", nAnonymizePositroniumAmount);
            emit AnonymizePositroniumAmountChanged(nAnonymizePositroniumAmount);
            break;
        default:
            break;
        }
